...
# Model Load Lib
import tensorflow
from venv.data_preprocessing import get_stem_words
...
def preprocess_user_input(user_input):
    ...
    print( "Boy Response: ",response)

    # convert the user input into its root words : stemming
    stemmed_words = get_stem_words(words, ignore_words)
    # Remove duplicacy and sort the user_input
    bag_of_words = sorted(list(set(stemmed_words)))
